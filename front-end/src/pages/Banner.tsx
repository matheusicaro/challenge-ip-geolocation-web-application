...
const Banner: React.FC = () => {
  return (
    <Container>
      <p className="banner-contrast">Coderbyte Challenge for the Full Stack Developer Project</p>
      <p className="banner-topics">- Developed in React and Node.js for the back end</p>
      <p className="banner-topics">
        - Repository at:
        <a
          href="https://github.com/matheusicaro/coderbyte-full-stack-project"
